                ...
                <div class="container-fluid">
                    ...
                    <span class="btn btn-info btn-xs deselect-all">Deselect all</span></label> -->
                                                <select name="event_rt" id="event_rt" class="form-control select2">
                                                    ...
                                                    <option value="{{ $id }}" {{ (in_array($id, old('event_rt', [])) || isset($event) && $event->event_rt) ? 'selected' : '' }}>
                                                        {{ $event_rt }}
                                                    </option>
                                                    @endforeach
                                                </select>
                    ...
                    <span class="btn btn-info btn-xs deselect-all">Deselect all</span></label> -->
                                        ...
                                        <div class="form-group {{ $errors->has('event_date') ? 'has-error' : '' }}">
                                            ...
                                            <input type="date" id="event_date" name="event_date" class="form-control" value="{{ old('event_date', isset($event) ? $event->event_date : '') }}">
