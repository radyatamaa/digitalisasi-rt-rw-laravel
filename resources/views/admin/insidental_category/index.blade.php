        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>List Kategori Insidental</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">List Kategori Insidental</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <!-- /.card -->
                            @section('content')
                            @can('insidental_category_create')
                            <div style="margin-bottom: 10px;" class="row">
                                <div class="col-lg-12">
                                    <a class="btn btn-success" href="{{ route("admin.insidental_category.create") }}">
                                        {{ trans('global.add') }} {{ trans('global.insidental_category.title_singular') }}
                                    </a>
                                </div>
                            </div>
                            @endcan
                            <div class="card">
                                <div class="card-header">
                                    {{ trans('global.insidental_category.title_singular') }} {{ trans('global.list') }}
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        {{ trans('global.insidental_category.fields.id_rt') }}
                                                    </th>
                                                    <th>
                                                        &nbsp;
                                                    </th>
                                            ...
                                            <tbody>
                                                @foreach($insidental_category as $key => $insidental_categorys)
                                                <tr data-entry-id="{{ $insidental_categorys->id }}">
                                                    <td>
                                                        {{ $key + 1}}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @can('insidental_category_show')
                                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.insidental_category.show', $insidental_categorys->id) }}">
                                                            {{ trans('global.view') }}
                                                        </a>
                                                        @endcan
                                                        @can('insidental_category_edit')
                                                        <a class="btn btn-xs btn-info" href="{{ route('admin.insidental_category.edit', $insidental_categorys->id) }}">
                                                            {{ trans('global.edit') }}
                                                        </a>
                                                        @endcan
                                                        @can('insidental_category_delete')
                                                        <form action="{{ route('admin.insidental_category.destroy', $insidental_categorys->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
