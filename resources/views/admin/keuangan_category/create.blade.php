...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.keuangan_category.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.keuangan_category.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
