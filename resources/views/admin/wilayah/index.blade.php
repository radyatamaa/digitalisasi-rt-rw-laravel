                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div style="margin-bottom: 10px;" class="row">
                                <div class="col-lg-12">
                                    <a class="btn btn-success" href="{{ route("admin.wilayah.create") }}">
                                        {{ trans('global.add') }} {{ trans('global.wilayah.title_singular') }}
                                    </a>
                                </div>
                            </div>
                            @endcan
                            <div class="card">
                                <div class="card-header">
                                    {{ trans('global.wilayah.title_singular') }} {{ trans('global.list') }}
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                @foreach($wilayah as $key => $wilayahs)
                                                <tr data-entry-id="{{ $wilayahs->id }}">
                                                    <td>
                                                        {{ $key + 1}}
                                                    </td>
                                                    <td>
                                                        {{ $wilayahs->wilayah_name ?? '' }}
                                                    </td>
                                                    <td>
                                                        <!-- @can('wilayah_show')
                                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.wilayah.show', $wilayahs->id) }}">
                                                            {{ trans('global.view') }}
                                                        </a>
                                                        @endcan -->
                                                        @can('wilayah_edit')
                                                        <a class="btn btn-xs btn-info" href="{{ route('admin.wilayah.edit', $wilayahs->id) }}">
                                                            {{ trans('global.edit') }}
                                                        </a>
                                                        @endcan
                                                        @can('wilayah_delete')
                                                        <form action="{{ route('admin.wilayah.destroy', $wilayahs->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
