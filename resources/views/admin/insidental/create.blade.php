                            ...
                            <div class="card">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Create Insidental</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                ...
                <p class="helper-block">
                    ...
                    <span class="btn btn-info btn-xs deselect-all">Deselect all</span></label> -->
                                            ...
                                            <div class="form-group {{ $errors->has('ins_date') ? 'has-error' : '' }}">
                                                ...
                                                <input type="date" id="ins_date" name="ins_date" class="form-control" value="{{ old('ins_date', isset($insidental) ? $insidental->ins_date : '') }}" step="0.01" required>
